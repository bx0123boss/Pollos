...
namespace Punto_Venta
{
    class Conexion
    {
        ...
        //public static string CadConSql = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Jaeger Soft\FastFood.mdf;Integrated Security=True";
        //public static string CadConSql = @"Server=DESKTOP-UCR1IUV\SQLEXPRESS;AttachDbFilename=C:\Jaeger Soft\FastFood.mdf;Database=FastFood;Integrated Security=True;";
